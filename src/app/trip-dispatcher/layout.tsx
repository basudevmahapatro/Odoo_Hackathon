...
type TripDispatcherLayoutProps = {
...
export default function TripDispatcherLayout({ children }: TripDispatcherLayoutProps) {
		...
		<div className="min-h-screen bg-white text-black">
			...
			>
				<nav className="space-y-1 px-2 py-6">
					{navItems.map((item) => {
						const isActive = item.label === "Trip Dispatcher";
			...
			>
				...
				<SearchFilters placeholder="Search trips" />
