...
type ExpenseAndFuelLayoutProps = {
...
export default function ExpenseAndFuelLayout({ children }: ExpenseAndFuelLayoutProps) {
		...
		<div className="min-h-screen bg-white text-black">
			...
			>
				<nav className="space-y-1 px-2 py-6">
					{navItems.map((item) => {
						const isActive = item.label === "Trip Expenses & Fuel";
			...
			>
				...
				<SearchFilters placeholder="Search expenses and fuel" />
